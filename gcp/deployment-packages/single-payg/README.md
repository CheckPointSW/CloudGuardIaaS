...
This directory contains the CloudGuard IaaS deployment package for Management, Gateway and Standalone PAYG solution published in the [GCP Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/checkpoint.vsec?tab=Overview).
...
2. Browse to the CloudGuardIaaS/gcp/deployment-packages/single-payg/ directory
...
7. Upload content of the CloudGuardIaaS/gcp/deployment-packages/single-payg/ directory  to the [cloud shell](https://cloud.google.com/shell/docs/uploading-and-downloading-files) 
