...
|  |  |  |  |  |
| **installationType** | Installation type and version | string | R81.10 Gateway only<br/>R81.10 Management only<br/>R81.10 Manual Configuration<br/>R81.10 Gateway and Management (Standalone)<br/>R81.20 Gateway only<br/>R81.20 Management only<br/>R81.20 Manual Configuration<br/>R81.20 Gateway and Management (Standalone)<br/>R82 Gateway only<br/>R82 Management only<br/>R82 Manual Configuration<br/>R82 Gateway and Management (Standalone) |
|  |  |  |  |  |
